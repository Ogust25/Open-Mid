    ...
    return (
      <nav className='flex flex-col items-center'>
        <div className='bg-container w-11/12 rounded-3xl flex items-center p-3 mt-3 justify-between text-white text-xl drop-shadow-xl'>
          <Link to='/'><img className='h-14' src={omBanner} alt='Nom et banière de la guilde'></img></Link>
          <ul className='flex justify-evenly w-2/3'>
            <li className='hover:text-blue-200 cursor-pointer'><Link to='/roster'>Roster</Link></li>
